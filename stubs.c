...
enum selabel_cmp_result selabel_cmp(struct selabel_handle *h1,
                                    struct selabel_handle *h2) { return SELABEL_INCOMPARABLE; }
...
int selinux_android_file_context_handle(void) { return 0xDEADBEEF; }
int selinux_android_hw_service_context_handle(void) { return 0xDEADBEEF; }
int selinux_android_prop_context_handle(void) { return 0xDEADBEEF; }
int selinux_android_restorecon(void) { return 0xDEADBEEF; }
int selinux_android_restorecon_pkgdir(void) { return 0xDEADBEEF; }
int selinux_android_service_context_handle(void) { return 0xDEADBEEF; }
int selinux_android_set_sehandle(void) { return 0xDEADBEEF; }
int selinux_android_setcontext(void) { return 0xDEADBEEF; }
int selinux_android_vendor_service_context_handle(void) { return 0xDEADBEEF; }
int selinux_log_callback(int type, const char *fmt, ...) { return 0; }
